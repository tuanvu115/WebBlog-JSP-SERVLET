										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Thêm Comment' href='<c:url value="/admin-comment?type=edit"/>'>
															<span>
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>
																<c:url var="urlView" value='/admin-comment?type=view&id=${item.id}'/>
																<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
			...
			function deleteNew(data) {
		        $.ajax({
		            ...
		            success: function (result) {
		                window.location.href = "${CommentURL}?type=list&maxPageItem=10&page=1&message=delete_success&alert=success";
		            },
		            error: function (error) {
		            	window.location.href = "${CommentURL}?type=list&maxPageItem=10&page=1&message=error_system&alert=danger";
		            }
		        });
		    }
		</script>
