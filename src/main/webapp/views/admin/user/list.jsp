										...
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<a flag="info"
												   ...
												   title='Thêm user' href='<c:url value="/admin-user?type=edit"/>'>
															<span>
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>
																<c:url var="urlView" value='/admin-user?type=view&id=${item.id}'/>
																<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
			...
			function deleteNew(data) {
		        $.ajax({
		            ...
		            success: function (result) {
		                window.location.href = "${UserURL}?type=list&maxPageItem=5&page=1&message=delete_success&alert=success";
		            },
		            error: function (error) {
		            	window.location.href = "${UserURL}?type=list&maxPageItem=5&page=1&message=error_system&alert=danger";
		            }
		        });
		    }
		</script>
